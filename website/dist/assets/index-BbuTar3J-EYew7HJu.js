import{c as r,n as d,t as c,l as h,j as i,d as w,F as u}from"./styles-ChWDJ3ue-Ndk079rm.js";const a=u`
  <svg
    version="1.1"
    id="Capa_1"
...
`;let n=class extends h{render(){const e=(()=>{var t,l;const s=window.navigator.userAgent,o=((l=(t=window.navigator)===null||t===void 0?void 0:t.userAgentData)===null||l===void 0?void 0:l.platform)||window.navigator.platform;return["macOS","Macintosh","MacIntel","MacPPC","Mac68K"].indexOf(o)!==-1?"Mac OS":["iPhone","iPad","iPod"].indexOf(o)!==-1?"iOS":["Win32","Win64","Windows","WinCE"].indexOf(o)!==-1?"Windows":/Android/.test(s)?"Android":/Linux/.test(o)?"Linux":null})();return i`
    ...
    `}tryAgain(){var e;this.close(),(e=this.doTryAgain)===null||e===void 0||e.call(this)}close(){this.shadowRoot.querySelector("ew-dialog").close()}async _handleClose(){this.parentNode.removeChild(this)}};n.styles=[r,d`
      li + li,
      li > ul {
        margin-top: 8px;
      }
    ...
    `],n=c([w("ewt-no-port-picked-dialog")],n);const v=async e=>{const t=document.createElement("ewt-no-port-picked-dialog");return t.doTryAgain=e,document.body.append(t),!0};export{v as openNoPortPickedDialog};
